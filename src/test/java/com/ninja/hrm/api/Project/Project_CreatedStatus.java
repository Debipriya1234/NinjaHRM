...
public class Project_CreatedStatus extends BaseAPIClass{
	...
	public void addSingleProjectWithCreatedTest() throws Throwable {
		...
		pojoObj= new ProjectPojo(projectName, "created", "Debipriya", 0);
		...
		boolean flag1=dbLib.executeQueryVerifyAndGetData("select * from project", 4, projectName);
		Assert.assertTrue(flag,"Project in DB is not verified");
