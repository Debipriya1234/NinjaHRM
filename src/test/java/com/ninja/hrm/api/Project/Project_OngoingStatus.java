...
public class Project_OngoingStatus extends BaseAPIClass{
	
	ProjectPojo pojoObj;
	
	@Test
    public void addProjectWithOngoingStatus() throws Throwable {
		...
		pojoObj= new ProjectPojo(projectName, "Ongoing", "Debipriya", 0);
